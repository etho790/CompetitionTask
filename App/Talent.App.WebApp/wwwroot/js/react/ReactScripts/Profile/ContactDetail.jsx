...
export class IndividualDetailSection extends Component {
    ...
    render() {
        return (
            ...
            //showEditSection is false to begin with so it will execute renderDisplay, in which once you click the button,
            //showEditSection ends up being true and executes renderEdit
        )
    }
    ...
    renderEdit() {
        return (
            <div className='ui sixteen wide column'>
                ...
                />
                <ChildSingleInput           //LAST NAME BIT ADDED!!!!!!!!!!!!!
                    inputType="text"
                    label="Last Name"
                    name="lastName"
    ...
    renderDisplay() {
        //last name ends up being turned undefined the minute we click save
        let Name = this.props.details ? `${this.props.details.firstName + " " + this.props.details.lastName}` : ""
        ...
        return (
            <div className='row'>
                <div className="ui sixteen wide column">
                    ...
                    <button type="button" className="ui right floated teal button" /*added on click for the button*/ onClick={this.openEdit}>Edit</button>
                </div>
            </div>
        )
    }
